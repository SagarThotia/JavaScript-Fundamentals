...
// const coffee = createUser("coffee", 2);
// const koffee = createUser("koffee", 250);
const coffee = new createUser("coffee", 2);
const koffee = new createUser("koffee", 250);
...
/*
    function is function and function is also object.
    
    Function:
    
    The prototype data property of a Function instance is used when the function is used as 
    a constructor with the new operator. It will become the new object's prototype.
